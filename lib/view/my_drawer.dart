        ...
        return CupertinoAlertDialog(
          ...
          actions: [
            ...
            TextButton(
              onPressed: () {
                FirestoreHelper()
                    .stockageFiles("PHOTOS", moi.uid, nameImage!, bytesImage!)
                    .then((value) {
                  setState(() {
                    moi.avatar = value;
                  });
          ...
          children: [
            ...
            ListTile(
              ...
              trailing: IconButton(
                ...
                icon: FaIcon(
                  (isEditing) ? FontAwesomeIcons.save : FontAwesomeIcons.pencil,
                  size: 20,
                  color: Colors.black,
                ),
              ),
            ...
            // Autres informations à afficher (si nécessaire)
          ],
        ),
      ),
    );
